...
export default function Sidebar({ mobileOpen = false, setMobileOpen = () => {} }) {
  ...
  if (!user) return null;
  const links = user.role === "engineer" ? [["/engineer", "⌂", "Dashboard"], ["/engineer-requests", "▣", "Client Requests"], ["/reports", "▤", "Reports"], ["/appointments", "◷", "Appointments"], ["/calendar", "▦", "Calendar"], ["/engineer-messages", "✉", "Messages"], ["/users", "♙", "User Management"]] : [["/client", "⌂", "Dashboard"], ["/requests", "▣", "My Requests"], ["/calendar", "▦", "Calendar"], ["/client-messages", "✉", "Messages"]];
